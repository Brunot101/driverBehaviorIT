...
import json
import re
arquivo = "trafficDriveFull60_dx6_with_y.csv"
df = pd.read_csv("../traficDriveLineSemReps/" + arquivo, sep=",")
...
dt1  = DecisionTreeClassifier(n_estimators=100, random_state=42)
...
with open("teoriaInformacaoLinhaW"+ window+"_dx_"+dx_valor+".json", "w") as f:
