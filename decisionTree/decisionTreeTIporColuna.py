...
print("=== Cenário 2: Features com teoria da informação por Coluna (Decision Tree) com 5-Fold Cross-Validation ===")
...
with open("teoriaInformacaoColuna_DT_W"+ window+"_dx_"+dx_valor+".json", "w") as f:
