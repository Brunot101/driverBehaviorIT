import pandas as pd
from informationAlt import ExtractInformation, choose_embedded_dimension, join_parts
import os
...
def main():
    ...
    path_out_prefix = f"lineInformation/19drivers_{window_length}_dx{dx}"
    os.makedirs("lineInformation", exist_ok=True)
